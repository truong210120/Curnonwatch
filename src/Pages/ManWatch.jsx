      ...
      return (
            <div className=''>
                  <div className='p-[30px]'>
                        <img className='max-w-full max-h-full object-center object-cover' src='https://curnonwatch.com/_next/image/?url=https%3A%2F%2Fshop.curnonwatch.com%2Fmedia%2Fcatalog%2Fcategory%2Fmen.jpg&w=1920&q=75' />
                  </div>
                  <div className='max-w-[1170px] my-0 mx-auto'>
                        <h1 className='text-[32px] leading-[32px] font-[700] pb-[22px] pt-[30px]'>MEN'S BEST SELLERS</h1>
                        <div className='flex justify-between text-[16px] text-[#969799]'>
                              <p className='w-[522px]'>Những mẫu đồng hồ nam được yêu thích và săn lùng nhiều nhất của Curnon. Hãy lựa chọn sản phẩm bạn yêu thích trước khi quá muộn.</p>
